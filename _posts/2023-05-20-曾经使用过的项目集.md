...
<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241243.png" style="zoom: 33%;" />

[下载地址，来源bugku](https://ctf.bugku.com/challenges/detail/id/2.html)

选择文件，然后用utf-8编码打开

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241118.png" alt="image-20230528130951914" style="zoom:67%;" />

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241834.png" alt="image-20230528131050518" style="zoom:50%;" />

末尾的最后，是unicode，放入浏览器的搜索栏直接能跳出来。

![image-20230528131156956](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241210.png)

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241700.png" alt="image-20230528131308399" style="zoom: 50%;" />

### task_Misc.png

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241005.png" alt="image-20230529143936923" style="zoom:50%;" />
...
![image-20230529150637939](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241419.png)

![image-20230529150721274](image-20230529150721274.png)

我们现在打开output看看。audit.txt就像报告一样，然后jpg，pdf，以及原图是png。

![image-20230529150837263](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241024.png)

![image-20230529150954583](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241961.png)

点开pdf发现有加密，flag应该就在此处，而jpg能够正常打开，png就是明图，那么对于jpg还要再做一次隐写查看。

![image-20230529151233487](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241920.png)

```
steghide extract -sf 文件名  # 然后一般默认无密码的话就enter一下，这里是没问题的
```

![image-20230529151622517](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241945.png)

![image-20230529151652378](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241964.png)

成功打开，就是我还得研究一下这个缩放的问题，感觉要买老花眼了😂😂😂

![image-20230529151740699](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241294.png)

### 利用010编辑器修改图片长宽（实例演示）

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241690.png" alt="image-20230601111907761" style="zoom: 33%;" />
...
![image-20230601112219888](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241249.png)

这里ctrl f选择value，输入其中一个值来寻找。

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241576.png" alt="image-20230601112323976" style="zoom:50%;" />

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241972.png" alt="image-20230601112547832" style="zoom:50%;" />

讲高度改高即可，我这里选择2048，效果如下。以后自己改尺寸也方便很多（）。

<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241509.png" alt="image-20230601112713819" style="zoom: 33%;" />
...
<img src="https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241211.png" alt="image-20230603013935556" style="zoom: 50%;" />

#### 3.bpg文件

![image-20230603014552945](https://cdn.jsdelivr.net/gh/rainsbluechan/blogimage@main/img/202310112241233.png)
